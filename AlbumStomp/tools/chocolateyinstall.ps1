...
$url        = 'https://stompsoftware.com/downloadfiles/albumstomp/SetupAlbumStompV2.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'AlbumStomp*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
