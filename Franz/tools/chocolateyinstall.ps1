...
$url        = 'https://github.com/imprecision/franz-app/releases/download/3.1.1/Franz-win32-ia32-3.1.1.zip'
$url64      = 'https://github.com/imprecision/franz-app/releases/download/3.1.1/Franz-win32-x64-3.1.1.zip'
$fileType = 'EXE'
$silentArgs = ''
