...
$packageName= 'vivaldi.portable' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://downloads.vivaldi.com/stable/Vivaldi.1.2.490.39.exe' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'vivaldi.portable*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
...
$downloadedFile = Get-ChocolateyWebFile $packageName "$toolsDir\vivaldi.exe" $url
