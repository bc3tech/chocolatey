...
$downloadedFile = Get-ChocolateyWebFile $packageName "$toolsDir\vivaldi-downloaded.zip" -Url 'https://downloads.vivaldi.com/snapshot/Vivaldi.1.3.551.37.exe' -Url64bit 'https://downloads.vivaldi.com/snapshot/Vivaldi.1.3.551.37.x64.exe'
