...
$packageName = 'vivaldi.install'
$softwareName = 'vivaldi*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
# $installerType = 'MSI' 
$installerType = 'EXE' 
